...
class Chat(DBBase):
    ...
    tags: Mapped[List[Tag]] = relationship(secondary=_chats_to_tags_assoc_table, cascade="all, delete")
    image_id: Mapped[int | None] = mapped_column(ForeignKey("images.id"), default=None)
    users: Mapped[List[User]] = relationship(secondary=_chats_to_users_assoc_table, cascade="all, delete")
    admins: Mapped[List[User]] = relationship(secondary=_chats_to_admins_assoc_table, cascade="all, delete")
